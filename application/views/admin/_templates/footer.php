...
<?php endif; ?>
        ...
        <script src="<?= jspath(); ?>datatables/jquery.dataTables.js" type="text/javascript"></script>
        <script src="<?= jspath(); ?>datatables/dataTables.bootstrap.js" type="text/javascript"></script>
        <script src="<?= jspath(); ?>datatables/fnReloadAjax.js" type="text/javascript"></script>
</body>
</html>